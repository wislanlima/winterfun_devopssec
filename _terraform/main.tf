...
#influxdb instance creation
resource "aws_instance" "influxdb_winterfun" {
  ami           = "ami-08ca3fed11864d6bb"
  instance_type = "t3.medium"
  subnet_id     = "subnet-065588da7b835f2b9"
  associate_public_ip_address = true
...
output "influxdb_winterfun"{
value = "${aws_instance.influxdb_winterfun.public_ip}"
}
